...
async function options(app) {
    ...
    tabs.createTab('appearance', app.createElement('div', [app.createElement('section', [app.createElement('span', 'Theme', {
        style: {
            display: 'block',
            'margin-bottom': '10px',
            'font-size': '18px',
        ...
        class: 'data-section'
    }), app.createElement('section', [app.createElement('span', 'Background', {
        style: {
            display: 'block',
            'margin-bottom': '10px',
            'font-size': '18px',
    ...
    tabs.createTab('tabs', app.createElement('div', [app.createElement('section', [app.createElement('span', 'Tab Title', {
        style: {
            display: 'block',
            'margin-bottom': '6px',
            'font-size': '18px',
        ...
        class: 'data-section'
    }), app.createElement('section', [app.createElement('span', 'Tab Icon', {
        style: {
            display: 'block',
            'margin-bottom': '6px',
            'font-size': '18px',
    ...
    app.search.back.setAttribute('onclick', '(' + (function() {
...
async function createAbout(app) {
    ...
    for (const entry of json.authors) {
        authors.push(app.createElement('p', `${entry.name}${entry.data?' - '+entry.data:''}`, {
            style: {
                'margin-bottom': '0'
            }
        }))
    ...
    for (const entry of json.socials) {
        socials.push(app.createElement('p', `${entry.name}${entry.data?' - '+entry.data:''}`, {
            style: {
                'margin-bottom': '0'
            }
        }))
    ...
    for (const entry of json.contact) {
        contacts.push(app.createElement('p', `${entry.name}${entry.data?' - '+entry.data:''}`, {
            style: {
                'margin-bottom': '0'
            }
        }))
    };
    return [app.createElement('section', [app.createElement('span', json.main.title, {
        style: {
            display: 'block',
            'margin-bottom': '6px',
            'font-size': '18px',
        ...
        class: 'data-section'
    }), app.createElement('section', [app.createElement('span', 'Authors', {
        style: {
            display: 'block',
            'margin-bottom': '6px',
            'font-size': '18px',
        ...
        class: 'data-section'
    }), app.createElement('section', [app.createElement('span', 'Socials', {
        style: {
            display: 'block',
            'margin-bottom': '6px',
            'font-size': '18px',
        ...
        class: 'data-section'
    }), contacts.length ? app.createElement('section', [app.createElement('span', 'Contact', {
        style: {
            display: 'block',
            'margin-bottom': '6px',
            'font-size': '18px',
